      ...
      <Box bg="white" p="4" rounded="md" shadow="sm">
        <HStack justifyContent="space-between" pb="3">
          <Icon
            ...
            as={MdWorkOutline}
          />
          <Badge bg="gray.100" fontSize="1em" px="2" py="1" rounded="md">
            <Box
              as="span"
              fontWeight="medium"
    ...
    <Box>
      ...
      <Box bg="white" rounded="md" shadow="sm">
        <Box bgGradient="linear(to-b, purple.100, purple.50)" p="4" h="28">
          <Badge bg="white" fontSize="1em" px="2" py="1" rounded="md">
            <Box
              as="span"
              fontWeight="medium"
              textTransform="capitalize"
...
const ProjectDeals = () => {
  return (
    <Box>
      ...
      <Box bg="white" rounded="md" shadow="sm">
        <Heading as="h2" size="md" px="4" pt="4">
          Project deals
        </Heading>
        <Divider py="2" />
